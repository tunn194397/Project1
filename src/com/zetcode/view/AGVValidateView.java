...
public class AGVValidateView extends JPanel implements ActionListener {
    ...
    public AGVValidateView(Container Container) {
    ...
    public void setUpValidateView() {
        ...
        JSlider maxAGV = new JSlider(JSlider.HORIZONTAL, 0, 20, container.validate.maxNumberOfAgv);
        JPanel maxAGVPanel = setUpSliderPanel("Số AGV tối đa : ", maxAGV, new JTextField(), 10, 10);

        JSlider velocOfAGV = new JSlider(JSlider.HORIZONTAL, 0, 10, container.validate.velocityOfAgv);
        JPanel velocOfAGVPanel = setUpSliderPanel("Vận tốc AGV : ", velocOfAGV, new JTextField(), 10, 70);

        JButton applyButton = new JButton("Apply");
        applyButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                container.validate.setValidateAGV(maxAGV.getValue(), velocOfAGV.getValue());
            }
        });
        applyButton.setBounds(250, 400, 80, 30);
        validatePanel.setBounds(350, 150, 800, 450);
        validatePanel.setLayout(null);
        validatePanel.add(maxAGVPanel);
        validatePanel.add(velocOfAGVPanel);
