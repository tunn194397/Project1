...
public class AudioValidateView extends JPanel implements ActionListener {
        ...
        public AudioValidateView(Container Container) {
        ...
        public void setUpValidateView() {
            ...
            JSlider volume = new JSlider(JSlider.HORIZONTAL, 0, 100, container.validate.volumeOfAudio);
            JPanel volumePanel = setUpSliderPanel("Volume : ", volume, new JTextField(), 10, 10);

            JButton applyButton = new JButton("Apply");
            applyButton.addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                    container.validate.setValidateAudio(volume.getValue());
                }
            });
            applyButton.setBounds(250, 400, 80, 30);
            validatePanel.setBounds(350, 150, 800, 450);
            validatePanel.setLayout(null);
            validatePanel.add(volumePanel);
